...
final class OwnMessageCollectionViewStickerCell: UICollectionViewCell {
    ...
    func configure(_ user: User, message: Message, delegate: OwnMessageCollectionViewStickerCellDelegate) {
